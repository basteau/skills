...
Heading semantics and outline quality belong to [better-accessibility](../better-accessibility.md). Pick the element from the document structure, then use this reference to make that structure visually legible. Never pick a heading element for its browser-default size.

...
- Apply the [unslop](../unslop/SKILL.md) skill to every doc this skill touches. That skill owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
...
- Indent code snippets using the target repository's conventions. Write real paths and real symbols. Make every count or tree claim true at the commit that lands it, and include the command that regenerates it.

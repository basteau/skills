...
Status color is never the only signal of a state change; pair it with an icon or text. [better-accessibility](../better-accessibility.md) owns that requirement.
